...
.. _program_listing_file_plugin_source_ui_stories_StoryRecording.cpp:

Program Listing for File StoryRecording.cpp
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_stories_StoryRecording.cpp>` (``plugin/source/ui/stories/StoryRecording.cpp``)
