...
.. _program_listing_file_plugin_source_network_FeedDataManager.cpp:

Program Listing for File FeedDataManager.cpp
============================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_network_FeedDataManager.cpp>` (``plugin/source/network/FeedDataManager.cpp``)
