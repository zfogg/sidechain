...
.. _program_listing_file_plugin_source_ui_social_UserCard.cpp:

Program Listing for File UserCard.cpp
=====================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_social_UserCard.cpp>` (``plugin/source/ui/social/UserCard.cpp``)
