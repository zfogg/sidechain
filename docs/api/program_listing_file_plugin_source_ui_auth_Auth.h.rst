...
.. _program_listing_file_plugin_source_ui_auth_Auth.h:

Program Listing for File Auth.h
===============================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_auth_Auth.h>` (``plugin/source/ui/auth/Auth.h``)
