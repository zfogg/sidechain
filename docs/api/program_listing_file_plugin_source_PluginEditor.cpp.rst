...
.. _program_listing_file_plugin_source_PluginEditor.cpp:

Program Listing for File PluginEditor.cpp
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_PluginEditor.cpp>` (``plugin/source/PluginEditor.cpp``)
