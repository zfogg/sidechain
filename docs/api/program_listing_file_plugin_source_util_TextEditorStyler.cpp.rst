...
.. _program_listing_file_plugin_source_util_TextEditorStyler.cpp:

Program Listing for File TextEditorStyler.cpp
=============================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_util_TextEditorStyler.cpp>` (``plugin/source/util/TextEditorStyler.cpp``)
