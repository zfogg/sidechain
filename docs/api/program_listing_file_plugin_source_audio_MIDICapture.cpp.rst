...
.. _program_listing_file_plugin_source_audio_MIDICapture.cpp:

Program Listing for File MIDICapture.cpp
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_audio_MIDICapture.cpp>` (``plugin/source/audio/MIDICapture.cpp``)
