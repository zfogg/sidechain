...
.. _program_listing_file_plugin_source_ui_stories_StoriesFeed.cpp:

Program Listing for File StoriesFeed.cpp
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_stories_StoriesFeed.cpp>` (``plugin/source/ui/stories/StoriesFeed.cpp``)
...
.. code-block:: cpp
   ...
   void StoriesFeed::mouseWheelMove(const juce::MouseEvent& /*event*/,
   ...
   void StoriesFeed::drawStoryCircle(juce::Graphics& g, juce::Rectangle<int> bounds,
