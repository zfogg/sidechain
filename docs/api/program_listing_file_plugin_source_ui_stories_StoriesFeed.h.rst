...
.. _program_listing_file_plugin_source_ui_stories_StoriesFeed.h:

Program Listing for File StoriesFeed.h
======================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_stories_StoriesFeed.h>` (``plugin/source/ui/stories/StoriesFeed.h``)
...
.. code-block:: cpp
   ...
   //==============================================================================
   class StoriesFeed : public juce::Component,
                                 public juce::Timer
   {
   public:
       StoriesFeed();
       ...
       void setCurrentUserAvatarUrl(const juce::String& url) { currentUserAvatarUrl = url; }
   ...
   private:
       ...
       void drawStoryCircle(juce::Graphics& g, juce::Rectangle<int> bounds,
