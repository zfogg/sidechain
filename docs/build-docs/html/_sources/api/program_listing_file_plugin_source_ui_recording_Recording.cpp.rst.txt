...
.. _program_listing_file_plugin_source_ui_recording_Recording.cpp:

Program Listing for File Recording.cpp
======================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_recording_Recording.cpp>` (``plugin/source/ui/recording/Recording.cpp``)
