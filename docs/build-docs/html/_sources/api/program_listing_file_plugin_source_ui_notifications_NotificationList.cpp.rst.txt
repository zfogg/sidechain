...
.. _program_listing_file_plugin_source_ui_notifications_NotificationList.cpp:

Program Listing for File NotificationList.cpp
=============================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_notifications_NotificationList.cpp>` (``plugin/source/ui/notifications/NotificationList.cpp``)
