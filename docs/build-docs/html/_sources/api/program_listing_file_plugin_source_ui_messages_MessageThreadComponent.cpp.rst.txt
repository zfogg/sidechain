...
.. _program_listing_file_plugin_source_ui_messages_MessageThreadComponent.cpp:

Program Listing for File MessageThreadComponent.cpp
===================================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_messages_MessageThreadComponent.cpp>` (``plugin/source/ui/messages/MessageThreadComponent.cpp``)
...
.. code-block:: cpp
   ...
   void MessageThreadComponent::showAddMembersDialog()
   {
       ...
       Log::info("MessageThreadComponent: Add members dialog - placeholder (full UI pending)");
   }
   ...
   void MessageThreadComponent::showRemoveMembersDialog()
   {
       ...
       juce::AlertWindow::showMessageBoxAsync(juce::AlertWindow::InfoIcon,
           ...
           "Feature coming soon.");
       Log::info("MessageThreadComponent: Remove members dialog - placeholder (full UI pending)");
   }
