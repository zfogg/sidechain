...
.. _program_listing_file_plugin_source_ui_messages_MessagesList.cpp:

Program Listing for File MessagesList.cpp
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_messages_MessagesList.cpp>` (``plugin/source/ui/messages/MessagesList.cpp``)
