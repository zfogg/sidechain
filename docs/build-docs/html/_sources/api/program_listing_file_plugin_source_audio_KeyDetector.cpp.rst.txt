...
.. _program_listing_file_plugin_source_audio_KeyDetector.cpp:

Program Listing for File KeyDetector.cpp
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_audio_KeyDetector.cpp>` (``plugin/source/audio/KeyDetector.cpp``)
...
.. code-block:: cpp
   ...
   public:
       ...
       KeyDetector::Key detectKey(const juce::AudioBuffer<float>& buffer,
                                  double sampleRate,
                                  int numChannels)
       {
           Key result;
   ...
   KeyDetector::Key KeyDetector::detectKey(const juce::AudioBuffer<float>& buffer,
                                            double sampleRate,
                                            int numChannels)
   {
