...
.. _program_listing_file_plugin_source_ui_messages_AudioSnippetRecorder.cpp:

Program Listing for File AudioSnippetRecorder.cpp
=================================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_messages_AudioSnippetRecorder.cpp>` (``plugin/source/ui/messages/AudioSnippetRecorder.cpp``)
