...
.. _program_listing_file_plugin_source_ui_social_FollowersList.h:

Program Listing for File FollowersList.h
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_social_FollowersList.h>` (``plugin/source/ui/social/FollowersList.h``)
...
.. code-block:: cpp
   ...
   //==============================================================================
   class FollowersList : public juce::Component,
                                  private juce::Timer
   {
   public:
       enum class ListType
