...
.. _program_listing_file_plugin_source_stores_UserDataStore.cpp:

Program Listing for File UserDataStore.cpp
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_stores_UserDataStore.cpp>` (``plugin/source/stores/UserDataStore.cpp``)
