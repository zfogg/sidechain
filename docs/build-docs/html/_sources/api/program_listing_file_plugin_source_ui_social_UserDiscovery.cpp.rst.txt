...
.. _program_listing_file_plugin_source_ui_social_UserDiscovery.cpp:

Program Listing for File UserDiscovery.cpp
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_social_UserDiscovery.cpp>` (``plugin/source/ui/social/UserDiscovery.cpp``)
