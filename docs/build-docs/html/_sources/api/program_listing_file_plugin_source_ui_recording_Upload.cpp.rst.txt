...
.. _program_listing_file_plugin_source_ui_recording_Upload.cpp:

Program Listing for File Upload.cpp
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_recording_Upload.cpp>` (``plugin/source/ui/recording/Upload.cpp``)
