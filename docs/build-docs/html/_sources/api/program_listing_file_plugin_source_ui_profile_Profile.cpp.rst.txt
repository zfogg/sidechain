...
.. _program_listing_file_plugin_source_ui_profile_Profile.cpp:

Program Listing for File Profile.cpp
====================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_profile_Profile.cpp>` (``plugin/source/ui/profile/Profile.cpp``)
