...
.. _program_listing_file_plugin_source_audio_AudioCapture.cpp:

Program Listing for File AudioCapture.cpp
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_audio_AudioCapture.cpp>` (``plugin/source/audio/AudioCapture.cpp``)
