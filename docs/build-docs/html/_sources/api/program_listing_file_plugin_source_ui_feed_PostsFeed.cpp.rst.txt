...
.. _program_listing_file_plugin_source_ui_feed_PostsFeed.cpp:

Program Listing for File PostsFeed.cpp
======================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_feed_PostsFeed.cpp>` (``plugin/source/ui/feed/PostsFeed.cpp``)
