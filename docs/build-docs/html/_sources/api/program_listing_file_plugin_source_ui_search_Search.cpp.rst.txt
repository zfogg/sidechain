...
.. _program_listing_file_plugin_source_ui_search_Search.cpp:

Program Listing for File Search.cpp
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_search_Search.cpp>` (``plugin/source/ui/search/Search.cpp``)
...
.. code-block:: cpp
   ...
   void Search::performSearch()
   {
       ...
       Log::info("Search: Performing search - query: \"" + currentQuery + "\", tab: " + (currentTab == ResultTab::Users ? "Users" : "Posts"));
