...
.. _program_listing_file_plugin_source_ui_messages_MessageThreadComponent.h:

Program Listing for File MessageThreadComponent.h
=================================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_messages_MessageThreadComponent.h>` (``plugin/source/ui/messages/MessageThreadComponent.h``)
...
.. code-block:: cpp
   ...
   //==============================================================================
   class MessageThreadComponent : public juce::Component,
                                   public juce::Timer,
   ...
   public:
       ...
       ~MessageThreadComponent() override;
