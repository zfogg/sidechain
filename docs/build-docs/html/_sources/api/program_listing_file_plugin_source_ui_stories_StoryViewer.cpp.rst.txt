...
.. _program_listing_file_plugin_source_ui_stories_StoryViewer.cpp:

Program Listing for File StoryViewer.cpp
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_stories_StoryViewer.cpp>` (``plugin/source/ui/stories/StoryViewer.cpp``)
