...
.. _program_listing_file_plugin_source_ui_stories_PianoRoll.cpp:

Program Listing for File PianoRoll.cpp
======================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_stories_PianoRoll.cpp>` (``plugin/source/ui/stories/PianoRoll.cpp``)
...
.. code-block:: cpp
   ...
   void PianoRoll::setMIDIData(const juce::var& midiData)
   {
       ...
       Log::info("PianoRoll: Loaded " + juce::String(notes.size()) + " notes, " +
