...
.. _program_listing_file_plugin_source_ui_auth_Auth.cpp:

Program Listing for File Auth.cpp
=================================

|exhale_lsh| :ref:`Return to documentation for file <file_plugin_source_ui_auth_Auth.cpp>` (``plugin/source/ui/auth/Auth.cpp``)
