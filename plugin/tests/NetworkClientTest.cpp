...
TEST_CASE("NetworkClient uploadProfilePicture", "[NetworkClient][ProfilePicture]")
{
    ...
    SECTION("unauthenticated upload invokes callback with failure immediately")
    {
        ...
        juce::File tempFile = juce::File::getSpecialLocation(juce::File::tempDirectory)
                                  .getChildFile("test_profile_pic.jpg");
        tempFile.create();
    ...
    SECTION("upload does not crash with nullptr callback")
    {
        ...
        juce::File tempFile = juce::File::getSpecialLocation(juce::File::tempDirectory)
                                  .getChildFile("test_no_callback.png");
        tempFile.create();
    ...
    SECTION("unauthenticated upload with nullptr callback does not crash")
    {
        ...
        juce::File tempFile = juce::File::getSpecialLocation(juce::File::tempDirectory)
                                  .getChildFile("test_unauth_no_callback.jpg");
        tempFile.create();
...
TEST_CASE("NetworkClient MIME type detection", "[NetworkClient][ProfilePicture]")
{
    ...
    SECTION("JPEG files are accepted")
    {
        ...
        juce::File jpegFile = juce::File::getSpecialLocation(juce::File::tempDirectory)
                                  .getChildFile("profile.jpg");
        jpegFile.create();
    ...
    SECTION("PNG files are accepted")
    {
        ...
        juce::File pngFile = juce::File::getSpecialLocation(juce::File::tempDirectory)
                                 .getChildFile("profile.png");
        pngFile.create();
    ...
    SECTION("GIF files are accepted")
    {
        ...
        juce::File gifFile = juce::File::getSpecialLocation(juce::File::tempDirectory)
                                 .getChildFile("animated.gif");
        gifFile.create();
    ...
    SECTION("WebP files are accepted")
    {
        ...
        juce::File webpFile = juce::File::getSpecialLocation(juce::File::tempDirectory)
                                  .getChildFile("modern.webp");
        webpFile.create();
    ...
    SECTION("Unknown extension uses application/octet-stream")
    {
        ...
        juce::File unknownFile = juce::File::getSpecialLocation(juce::File::tempDirectory)
                                     .getChildFile("image.xyz");
        unknownFile.create();
...
TEST_CASE("NetworkClient profile picture file handling", "[NetworkClient][ProfilePicture]")
{
    ...
    {
        juce::File emptyFile = juce::File::getSpecialLocation(juce::File::tempDirectory)
                                   .getChildFile("empty.jpg");
        emptyFile.create();
    ...
    SECTION("large file name is handled")
    {
        ...
        juce::File longNameFile = juce::File::getSpecialLocation(juce::File::tempDirectory)
                                      .getChildFile(longName);
        longNameFile.create();
    ...
    {
        juce::File spacesFile = juce::File::getSpecialLocation(juce::File::tempDirectory)
                                    .getChildFile("my profile picture.png");
        spacesFile.create();
