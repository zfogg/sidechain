...
//==============================================================================
/**
 * UserDiscoveryComponent provides user search and discovery functionality
 *
 * Features:
 ...
 * - Genre filtering
 */
class UserDiscoveryComponent : public juce::Component,
                                public juce::TextEditor::Listener,
                                public juce::ScrollBar::Listener
{
public:
    UserDiscoveryComponent();
    ~UserDiscoveryComponent() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(UserDiscoveryComponent)
};
