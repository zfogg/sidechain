...
//==============================================================================
/**
 * UploadComponent provides the UI for sharing a recorded loop.
 *
 * Features:
 ...
 */
class UploadComponent : public juce::Component,
                        public juce::Timer
{
public:
    //==========================================================================
    ...
    //==========================================================================
    UploadComponent(SidechainAudioProcessor& processor, NetworkClient& network);
    ~UploadComponent() override;
