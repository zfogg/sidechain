 ...
 *
 * Features:
 * - Toggle to make account private/public
 ...
 */
class PrivacySettings : public AppStoreComponent<UserState>, public juce::Button::Listener {
public:
...
private:
  ...
  JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(PrivacySettings)
};
