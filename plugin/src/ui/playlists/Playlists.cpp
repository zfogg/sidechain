...
void Playlists::mouseWheelMove(const juce::MouseEvent& /*event*/,
...
void Playlists::loadPlaylists()
{
    ...
    {
        case FilterType::Owned: filter = "owned"; break;
        case FilterType::Collaborated: filter = "collaborated"; break;
        case FilterType::Public: filter = "public"; break;
