...
public:
     ...
     */
    static std::shared_ptr<TransitionAnimation> create(
        const T& startValue,
        const T& endValue,
        int durationMs)
    {
    ...
    virtual ~TransitionAnimation() = default;
 ...
 */
template<>
inline int TransitionAnimation<int>::linearInterpolate(const int& start, const int& end, float progress)
{
...
inline juce::Colour TransitionAnimation<juce::Colour>::linearInterpolate(
    const juce::Colour& start,
    const juce::Colour& end,
    float progress)
{
 ...
 */
template<>
inline juce::Point<float> TransitionAnimation<juce::Point<float>>::linearInterpolate(
 ...
 */
template<>
inline juce::Rectangle<float> TransitionAnimation<juce::Rectangle<float>>::linearInterpolate(
    const juce::Rectangle<float>& start,
    const juce::Rectangle<float>& end,
    float progress)
{
