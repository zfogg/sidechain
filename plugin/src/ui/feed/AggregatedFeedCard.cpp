...
AggregatedFeedCard::AggregatedFeedCard()
{
    ...
    activityCountLabel.setFont(juce::Font(13.0f));
...
void AggregatedFeedCard::updateSummary()
{
    ...
    // Set activity count
    activityCountLabel.setText(juce::String(groupData.activityCount) + " activities",
