...
public:
    ...
    void setIsOwnProfile(bool isOwn) { isOwnProfile = isOwn; }

    //==============================================================================
    // Data
    void loadHighlights();
    void setHighlights(const juce::Array<StoryHighlight>& highlights);
    const juce::Array<StoryHighlight>& getHighlights() const { return highlights; }
    bool hasHighlights() const { return !highlights.isEmpty(); }
    ...
    //==============================================================================
    // Layout
    int getPreferredHeight() const { return HIGHLIGHT_SIZE + NAME_HEIGHT + PADDING * 2; }
