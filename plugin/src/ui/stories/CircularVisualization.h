...
//==============================================================================
/**
 * CircularVisualization displays MIDI data in a radial/circular style (7.5.5.2.2)
 *
 * Features:
 ...
 * }
 */
class CircularVisualization : public juce::Component,
                               public juce::Timer
{
public:
    ...
    void setStyle(Style style) { visualStyle = style; repaint(); }
