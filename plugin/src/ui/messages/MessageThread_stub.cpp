...
void MessageThread::onAppStateChanged(const Sidechain::Stores::ChatState &state) { repaint(); }
...
bool MessageThread::hasUserReacted(const StreamChatClient::Message& message, const juce::String& reactionType) const { return false; }
int MessageThread::getReactionCount(const StreamChatClient::Message& message, const juce::String& reactionType) const { return 0; }
std::vector<juce::String> MessageThread::getReactionTypes(const StreamChatClient::Message& message) const { return {}; }

juce::Rectangle<int> MessageThread::getBackButtonBounds() const { return {}; }
juce::Rectangle<int> MessageThread::getSendButtonBounds() const { return {}; }
juce::Rectangle<int> MessageThread::getAudioButtonBounds() const { return {}; }
juce::Rectangle<int> MessageThread::getMessageBounds(const StreamChatClient::Message& message) const { return {}; }
juce::Rectangle<int> MessageThread::getHeaderMenuButtonBounds() const { return {}; }
juce::Rectangle<int> MessageThread::getSharedPostBounds(const StreamChatClient::Message& message) const { return {}; }
juce::Rectangle<int> MessageThread::getSharedStoryBounds(const StreamChatClient::Message& message) const { return {}; }
juce::Rectangle<int> MessageThread::getReplyPreviewBounds() const { return {}; }
juce::Rectangle<int> MessageThread::getCancelReplyButtonBounds() const { return {}; }
...
bool MessageThread::isGroupChannel() const { return false; }
...
juce::String MessageThread::formatTimestamp(const juce::String& timestamp) { return ""; }
int MessageThread::calculateMessageHeight(const StreamChatClient::Message& message, int maxWidth) const { return 50; }
int MessageThread::calculateTotalMessagesHeight() { return 0; }
bool MessageThread::isOwnMessage(const StreamChatClient::Message& message) const { return false; }

juce::String MessageThread::getReplyToMessageId(const StreamChatClient::Message& message) const { return ""; }
std::optional<StreamChatClient::Message> MessageThread::findParentMessage(const juce::String& messageId) const { return std::nullopt; }
void MessageThread::scrollToMessage(const juce::String& messageId) {}

bool MessageThread::hasSharedPost(const StreamChatClient::Message& message) const { return false; }
bool MessageThread::hasSharedStory(const StreamChatClient::Message& message) const { return false; }
void MessageThread::drawSharedPostPreview(juce::Graphics& g, const StreamChatClient::Message& message, juce::Rectangle<int> bounds) {}
void MessageThread::drawSharedStoryPreview(juce::Graphics& g, const StreamChatClient::Message& message, juce::Rectangle<int> bounds) {}
int MessageThread::getSharedContentHeight(const StreamChatClient::Message& message) const { return 0; }
