...
public:
  ...
  double getRecordingLengthSeconds() const {
    return audioCapture.getRecordingLengthSeconds();
  }
  ...
  double getMaxRecordingLengthSeconds() const {
    return audioCapture.getMaxRecordingLengthSeconds();
  }
  ...
  float getRecordingProgress() const {
    return audioCapture.getRecordingProgress();
  }
  ...
  float getPeakLevel(int channel) const {
    return audioCapture.getPeakLevel(channel);
  }
   ...
   */
  bool isBPMAvailable() const {
    return bpmAvailable.load();
  }
   ...
   */
  HttpAudioPlayer &getAudioPlayer() {
    return audioPlayer;
  }
   ...
   */
  const HttpAudioPlayer &getAudioPlayer() const {
    return audioPlayer;
  }
   ...
   */
  ChordSequenceDetector &getChordDetector() {
   ...
   */
  bool isSynthUnlocked() const {
    return synthUnlocked.load();
  }

  /** Set synth unlocked state (called by chord detector callback)
   * @param unlocked true to unlock synth
   */
  void setSynthUnlocked(bool unlocked) {
    synthUnlocked.store(unlocked);
  }
