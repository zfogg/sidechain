 ...
 * - Upload
 */
class SidechainAudioProcessorEditor : public juce::AudioProcessorEditor, public juce::ChangeListener {
public:
...
private:
   ...
   * @param direction Navigation direction for animation (Forward, Backward, or
   * None)
   */
