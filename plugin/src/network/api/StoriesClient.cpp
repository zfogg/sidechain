...
void NetworkClient::createHighlight(const juce::String& name,
...
void NetworkClient::updateHighlight(const juce::String& highlightId,
...
void NetworkClient::addStoryToHighlight(const juce::String& highlightId,
...
void NetworkClient::removeStoryFromHighlight(const juce::String& highlightId,
                                              const juce::String& storyId,
                                              ResponseCallback callback)
{
    if (!isAuthenticated())
