...
// Compatibility for steady_timer::expires_from_now (replaced with
// expires_after) Note: This requires patching websocketpp source or using a
// wrapper For now, we'll need to patch the websocketpp files directly
