 ...
 *
 * Implements OT (Operational Transform) for conflict resolution in concurrent edits.
 *
 * Core properties:
...
public:
     ...
     */
    static std::pair<std::shared_ptr<Operation>, std::shared_ptr<Operation>> transform(
        const std::shared_ptr<Operation>& op1,
    ...
    static std::string apply(const std::string& text, const std::shared_ptr<Operation>& op)
    {
        ...
        {
            std::string result = text;
            result.replace(mod->position, mod->oldContent.length(), mod->newContent);
            return result;
        }
...
private:
    ...
    static std::pair<std::shared_ptr<Operation>, std::shared_ptr<Operation>> transformInsertInsert(
        const std::shared_ptr<Insert>& ins1,
    ...
    static std::pair<std::shared_ptr<Operation>, std::shared_ptr<Operation>> transformInsertDelete(
    ...
    static std::pair<std::shared_ptr<Operation>, std::shared_ptr<Operation>> transformInsertModify(
        const std::shared_ptr<Insert>& ins,
    ...
    static std::pair<std::shared_ptr<Operation>, std::shared_ptr<Operation>> transformDeleteInsert(
        const std::shared_ptr<Delete>& del,
        const std::shared_ptr<Insert>& ins)
    {
    ...
    static std::pair<std::shared_ptr<Operation>, std::shared_ptr<Operation>> transformDeleteDelete(
        const std::shared_ptr<Delete>& del1,
    ...
    static std::pair<std::shared_ptr<Operation>, std::shared_ptr<Operation>> transformDeleteModify(
        const std::shared_ptr<Delete>& del,
        const std::shared_ptr<Modify>& mod)
    {
        auto resultDel = std::make_shared<Delete>(*del);
    ...
    static std::pair<std::shared_ptr<Operation>, std::shared_ptr<Operation>> transformModifyInsert(
        const std::shared_ptr<Modify>& mod,
        const std::shared_ptr<Insert>& ins)
    {
    ...
    static std::pair<std::shared_ptr<Operation>, std::shared_ptr<Operation>> transformModifyDelete(
        const std::shared_ptr<Modify>& mod,
        const std::shared_ptr<Delete>& del)
    {
    ...
    static std::pair<std::shared_ptr<Operation>, std::shared_ptr<Operation>> transformModifyModify(
        const std::shared_ptr<Modify>& mod1,
