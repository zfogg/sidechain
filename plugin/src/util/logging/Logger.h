...
public:
     ...
     * Log debug message
     */
    void debug(const juce::String& category, const juce::String& message,
     ...
     * Log info message
     */
    void info(const juce::String& category, const juce::String& message,
              const juce::String& context = "")
    {
     ...
     * Log warning message
     */
    void warning(const juce::String& category, const juce::String& message,
                 const juce::String& context = "")
    {
     ...
     * Log error message
     */
    void error(const juce::String& category, const juce::String& message,
               const juce::String& context = "")
    {
     ...
     * Log fatal message
     */
    void fatal(const juce::String& category, const juce::String& message,
               const juce::String& context = "")
    {
 ...
 */
inline void logDebug(const juce::String& category, const juce::String& message,
                     const juce::String& context = "")
{
    Logger::getInstance().debug(category, message, context);
}

inline void logInfo(const juce::String& category, const juce::String& message,
                    const juce::String& context = "")
{
    Logger::getInstance().info(category, message, context);
}

inline void logWarning(const juce::String& category, const juce::String& message,
                       const juce::String& context = "")
{
    Logger::getInstance().warning(category, message, context);
}

inline void logError(const juce::String& category, const juce::String& message,
                     const juce::String& context = "")
{
    Logger::getInstance().error(category, message, context);
}

inline void logFatal(const juce::String& category, const juce::String& message,
                     const juce::String& context = "")
{
