 ...
 *
 * Centralizes validation logic that was previously scattered across the
 * codebase. All functions are stateless and thread-safe.
 *
 * Usage:
 ...
 * Uses a practical regex that catches most invalid emails without being overly
 * strict.
 */
