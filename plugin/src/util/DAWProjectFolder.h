...
//==============================================================================
/**
 * DAWProjectFolder utility for detecting and accessing DAW project folders (R.3.3.7.1)
 * 
...
namespace DAWProjectFolder
{
     ...
     * 
     * @param detectedDAWName Optional DAW name to use (if already detected). If empty, will auto-detect.
