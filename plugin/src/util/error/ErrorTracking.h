 ...
 *   tracker->recordError("network", "Failed to connect", ErrorSeverity::Warning, {
...
public:
     ...
     */
    void recordError(ErrorSource source,
     ...
     */
    void recordException(ErrorSource source,
...
{
public:
    ScopedErrorContext(const juce::String& operationName,
                       const std::map<juce::String, juce::String>& context = {})
     ...
     * Get context map
     */
    const std::map<juce::String, juce::String>& getContext() const { return context_; }
