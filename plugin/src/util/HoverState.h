 ...
 *       }
 *
 *       void mouseEnter(const juce::MouseEvent&) override { hoverState.setHovered(true); }
 *       void mouseExit(const juce::MouseEvent&) override { hoverState.setHovered(false); }
 *
 ...
 *
 * Usage:
 *   HoverStateWithCursor hoverState(this, juce::MouseCursor::PointingHandCursor);
 ...
 *
 *   void mouseMove(const MouseEvent& e) { hovers.updateFromPoint(e.getPosition()); }
 */
