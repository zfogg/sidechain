...
public:
    ...
    // Note: In JUCE 8, audioDeviceIOCallback is deprecated in favor of audioDeviceIOCallbackWithContext
    // This method is kept for compatibility but override is removed as it may not be virtual in JUCE 8
