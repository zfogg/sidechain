...
//==============================================================================
/**
 * ProgressiveKeyDetector provides progressive/streaming key detection for audio
 * data.
 *
...
public:
   ...
   *
   * @param sampleRate Sample rate of the audio (must be consistent for all
   * chunks)
   * @return true if initialization successful, false if libkeyfinder
   * unavailable
   */
