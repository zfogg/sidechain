 ...
 *       ->addRule("username", InputValidator::alphanumeric().minLength(3).maxLength(20))
...
public:
    ...
    explicit ValidationResult(const juce::StringPairArray& errors)
        : isValid_(errors.size() == 0), errors_(errors)
    {
    }
     ...
     */
    const juce::StringPairArray& getErrors() const { return errors_; }
     ...
     */
    const juce::StringPairArray& getValues() const { return values_; }
...
public:
    ...
    juce::String getDescription() const override { return "Integer"; }
...
public:
     ...
     */
    static ValidationResult validateFileUpload(const juce::File& file,
                                                size_t maxSizeBytes,
