...
public:
     ...
     *
     * @return String describing the backend (e.g., "Keychain", "DPAPI", "SecretService")
     */
...
public:
     ...
     * @param key The identifier for the token
     */
    explicit TokenGuard(const juce::String& key)
        : key_(key)
    {
        auto store = SecureTokenStore::getInstance();
     ...
     */
    const juce::String& get() const { return value_; }
