...
public:
     ...
     * 
     * Automatically checks if notifications are supported on the current platform.
     * If not supported, returns false without showing a notification.
     * 
     ...
     */
    static bool show(const juce::String& title,
    ...
    /**
     * Request notification permissions (required on macOS, optional on other platforms)
     * 
     * This is a non-blocking call. The result will be delivered asynchronously
     * if a callback is provided.
     * 
     * @param callback Optional callback called with the permission result (true = granted)
     */
...
private:
    ...
    static bool showMacOS(const juce::String& title,
                          const juce::String& message,
                          const juce::String& subtitle,
                          bool sound);
    
    static bool showWindows(const juce::String& title,
                            const juce::String& message,
                            const juce::String& subtitle,
                            bool sound);
    
    static bool showLinux(const juce::String& title,
                          const juce::String& message,
                          const juce::String& subtitle,
                          bool sound);
