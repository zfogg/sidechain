...
void MidiChallenges::resized()
{
    ...
    // Position scroll bar
    scrollBar.setBounds(getWidth() - 12, HEADER_HEIGHT + FILTER_TAB_HEIGHT, 12, getHeight() - HEADER_HEIGHT - FILTER_TAB_HEIGHT);
}
...
void MidiChallenges::mouseWheelMove(const juce::MouseEvent& /*event*/,
...
void MidiChallenges::loadChallenges()
{
    ...
    {
        case FilterType::Active: status = "active"; break;
        case FilterType::Voting: status = "voting"; break;
        case FilterType::Past: status = "past"; break;
        case FilterType::Upcoming: status = "upcoming"; break;
...
{
    return juce::Rectangle<int>(0, HEADER_HEIGHT + FILTER_TAB_HEIGHT, getWidth(), getHeight() - HEADER_HEIGHT - FILTER_TAB_HEIGHT);
}
