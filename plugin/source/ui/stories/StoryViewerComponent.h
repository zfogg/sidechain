...
//==============================================================================
/**
 * StoryViewerComponent displays stories in a full-screen viewer (7.5.4.2.1)
 *
 * Features:
 ...
 */
class StoryViewerComponent : public juce::Component,
                              public juce::Timer
{
public:
    StoryViewerComponent();
    ~StoryViewerComponent() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(StoryViewerComponent)
};
