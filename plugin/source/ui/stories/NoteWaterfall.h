...
//==============================================================================
/**
 * NoteWaterfall visualizes MIDI data in a waterfall/falling notes style (7.5.5.2.1)
 *
 * Features:
 ...
 * }
 */
class NoteWaterfall : public juce::Component,
                      public juce::Timer
{
public:
    NoteWaterfall();
    ...
    void setLookaheadTime(double seconds) { lookaheadTime = seconds; repaint(); }
