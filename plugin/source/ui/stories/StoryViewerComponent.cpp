#include "StoryViewerComponent.h"
...
//==============================================================================
StoryViewerComponent::StoryViewerComponent()
{
    ...
    Log::info("StoryViewerComponent created");
}
...
StoryViewerComponent::~StoryViewerComponent()
{
    ...
    Log::info("StoryViewerComponent destroyed");
}

//==============================================================================
void StoryViewerComponent::paint(juce::Graphics& g)
{
    // Background
...
void StoryViewerComponent::resized()
{
...
void StoryViewerComponent::mouseUp(const juce::MouseEvent& event)
{
...
void StoryViewerComponent::mouseDown(const juce::MouseEvent& event)
{
    dragStartPoint = event.getPosition();
    isDragging = true;
}

void StoryViewerComponent::mouseDrag(const juce::MouseEvent& /*event*/)
{
    // Visual feedback during drag could be added here
}

//==============================================================================
void StoryViewerComponent::timerCallback()
{
...
//==============================================================================
void StoryViewerComponent::setStories(const std::vector<StoryData>& newStories, int startIndex)
{
    stories = newStories;
...
void StoryViewerComponent::showNextStory()
{
...
void StoryViewerComponent::showPreviousStory()
{
...
void StoryViewerComponent::closeViewer()
{
    // Stop playback
    if (audioPlayer)
        audioPlayer->stop();
...
void StoryViewerComponent::togglePlayPause()
{
    if (playing)
    {
        if (audioPlayer)
...
//==============================================================================
void StoryViewerComponent::drawHeader(juce::Graphics& g)
{
...
void StoryViewerComponent::drawProgressBar(juce::Graphics& g)
{
...
void StoryViewerComponent::drawStoryContent(juce::Graphics& g)
{
    const auto* story = getCurrentStory();
    if (!story)
    {
...
void StoryViewerComponent::drawWaveform(juce::Graphics& g, juce::Rectangle<int> bounds)
{
    // Background
    g.setColour(StoryViewerColors::surface);
...
void StoryViewerComponent::drawViewCount(juce::Graphics& g)
{
    const auto* story = getCurrentStory();
    if (!story)
        return;
...
void StoryViewerComponent::drawPlayPauseOverlay(juce::Graphics& g)
{
...
void StoryViewerComponent::drawExpiredMessage(juce::Graphics& g)
{
    // Dark overlay
...
void StoryViewerComponent::drawViewersButton(juce::Graphics& g)
{
...
void StoryViewerComponent::drawShareButton(juce::Graphics& g)
{
...
void StoryViewerComponent::handleShareStory(const juce::String& storyId)
{
    ...
    Log::info("StoryViewerComponent: Copied story link to clipboard: " + shareUrl);
}

//==============================================================================
void StoryViewerComponent::loadCurrentStory()
{
    const auto* story = getCurrentStory();
    if (!story)
        return;

    Log::info("StoryViewerComponent: Loading story " + story->id);

    // Check if story is expired
    if (story->isExpired())
    {
        Log::warn("StoryViewerComponent: Story " + story->id + " is expired");
...
void StoryViewerComponent::markStoryAsViewed()
{
    const auto* story = getCurrentStory();
...
void StoryViewerComponent::updateProgress()
{
    if (currentStoryIndex < 0 || currentStoryIndex >= static_cast<int>(progressSegments.size()))
        return;
...
void StoryViewerComponent::onStoryComplete()
{
...
const StoryData* StoryViewerComponent::getCurrentStory() const
{
