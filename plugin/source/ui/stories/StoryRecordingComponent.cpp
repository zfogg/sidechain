#include "StoryRecordingComponent.h"
...
//==============================================================================
StoryRecordingComponent::StoryRecordingComponent(SidechainAudioProcessor& processor)
    : audioProcessor(processor)
{
    ...
    Log::info("StoryRecordingComponent created");
}

StoryRecordingComponent::~StoryRecordingComponent()
{
    stopTimer();
    ...
    Log::info("StoryRecordingComponent destroyed");
}

//==============================================================================
void StoryRecordingComponent::paint(juce::Graphics& g)
{
    // Background
...
void StoryRecordingComponent::resized()
{
...
void StoryRecordingComponent::mouseUp(const juce::MouseEvent& event)
{
...
//==============================================================================
void StoryRecordingComponent::timerCallback()
{
    ...
    if (currentState == State::Recording)
    {
        ...
        {
            Log::info("StoryRecordingComponent: Auto-stopping at max duration");
            stopRecording();
            return;
        }
...
//==============================================================================
void StoryRecordingComponent::drawIdleState(juce::Graphics& g)
{
    drawHeader(g);
    drawCountdownRing(g);
    drawRecordButton(g);
...
void StoryRecordingComponent::drawRecordingState(juce::Graphics& g)
{
    drawHeader(g);
    drawCountdownRing(g);
    drawRecordButton(g);
...
void StoryRecordingComponent::drawPreviewState(juce::Graphics& g)
{
    drawHeader(g);
...
//==============================================================================
void StoryRecordingComponent::drawHeader(juce::Graphics& g)
{
    // Title
    g.setColour(StoryColors::textPrimary);
...
void StoryRecordingComponent::drawRecordButton(juce::Graphics& g)
{
...
void StoryRecordingComponent::drawTimeDisplay(juce::Graphics& g)
{
    g.setColour(StoryColors::textPrimary);
...
void StoryRecordingComponent::drawCountdownRing(juce::Graphics& g)
{
...
void StoryRecordingComponent::drawMIDIIndicator(juce::Graphics& g)
{
...
void StoryRecordingComponent::drawWaveformPreview(juce::Graphics& g)
{
    if (waveformArea.isEmpty())
        return;
...
void StoryRecordingComponent::drawPlaybackControls(juce::Graphics& g)
{
...
void StoryRecordingComponent::drawMetadataInput(juce::Graphics& g)
{
...
void StoryRecordingComponent::drawActionButtons(juce::Graphics& g)
{
    int buttonWidth = actionButtonsArea.getWidth() / 2 - 10;
...
//==============================================================================
juce::String StoryRecordingComponent::formatTime(double seconds)
{
...
juce::Path StoryRecordingComponent::generateWaveformPath(const juce::AudioBuffer<float>& buffer,
...
//==============================================================================
void StoryRecordingComponent::startRecording()
{
    Log::info("StoryRecordingComponent: Starting recording");
...
void StoryRecordingComponent::stopRecording()
{
    if (currentState != State::Recording)
        return;

    Log::info("StoryRecordingComponent: Stopping recording");
    ...
    if (bufferAudioPlayer && recordedAudio.getNumSamples() > 0)
    {
        ...
        Log::info("StoryRecordingComponent: Loaded " + juce::String(recordedAudio.getNumSamples()) +
...
void StoryRecordingComponent::discardRecording()
{
    Log::info("StoryRecordingComponent: Discarding recording");
...
void StoryRecordingComponent::confirmRecording()
{
    Log::info("StoryRecordingComponent: Confirming recording");
...
bool StoryRecordingComponent::canStopRecording() const
{
    return currentRecordingDuration >= MIN_DURATION_SECONDS;
}

void StoryRecordingComponent::togglePreviewPlayback()
{
    if (!bufferAudioPlayer || !bufferAudioPlayer->hasBuffer())
        return;
...
void StoryRecordingComponent::stopPreviewPlayback()
{
    if (bufferAudioPlayer)
    {
        bufferAudioPlayer->stop();
