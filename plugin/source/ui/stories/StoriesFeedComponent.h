...
//==============================================================================
/**
 * StoriesFeedComponent displays a horizontal scrollable list of story circles (7.5.4.1.1)
 *
 * Features:
 ...
 */
class StoriesFeedComponent : public juce::Component,
                              public juce::Timer
{
public:
    StoriesFeedComponent();
    ~StoriesFeedComponent() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(StoriesFeedComponent)
};
