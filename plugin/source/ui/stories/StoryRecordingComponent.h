...
//==============================================================================
/**
 * StoryRecordingComponent provides UI for recording short music clips (stories)
 ...
 */
class StoryRecordingComponent : public juce::Component,
                                 public juce::Timer
{
public:
    StoryRecordingComponent(SidechainAudioProcessor& processor);
    ~StoryRecordingComponent() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(StoryRecordingComponent)
};
