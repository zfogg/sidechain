...
//==============================================================================
/**
 * FollowUserRowComponent displays a single user in the followers/following list
 */
class FollowUserRowComponent : public juce::Component
{
public:
    FollowUserRowComponent();
    ~FollowUserRowComponent() override = default;

    void setUser(const FollowListUser& user);
    const FollowListUser& getUser() const { return user; }
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(FollowUserRowComponent)
};

//==============================================================================
/**
 * FollowersListComponent displays a list of followers or following users
 *
 * Features:
 ...
 * - Pagination support
 */
class FollowersListComponent : public juce::Component,
                               private juce::Timer
{
public:
    enum class ListType
    ...
    ~FollowersListComponent() override;
...
private:
    ...
    juce::OwnedArray<FollowUserRowComponent> userRows;
    ...
    // Row callbacks
    void setupRowCallbacks(FollowUserRowComponent* row);

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(FollowersListComponent)
};
