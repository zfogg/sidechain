...
#include "../social/UserCardComponent.h"  // For DiscoveredUser struct and UserCardComponent

class NetworkClient;

//==============================================================================
/**
 * SearchComponent provides comprehensive search functionality for users and posts
 *
 * Features:
