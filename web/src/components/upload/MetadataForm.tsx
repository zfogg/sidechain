...
const GENRES = [
  ...
  // Extremely Obscure & Experimental
  'Chap Hop',
  'Steampunk Music',
  'Medieval Folk Rock',
  'Psychobilly',
  ...
  // Underground Internet Genres
  'Streamer Background Music',
  'Twitch Music',
  'Meme Music',
  'Soundcloud Bedroom Pop',
  'Hyperpop Extended',
  'Brat Music',
  'Alt-Girl',
  'PopPunk Renaissance',
